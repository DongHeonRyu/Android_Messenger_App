    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                if(continueAndNextBtn.getText().equals("Submit") || checker.equals("Code Sent")){
                    ...
                    if(!phoneNumber.equals("")){
                        ...
                        loadingBar.show();
                        Log.v("aaaa", "doksodkpqkwdpwkoqpdkpska!!!!!!!!!!!!!!");
                        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                                phoneNumber, 60, TimeUnit.SECONDS, RegistrationActivity.this, mCallbacks
                        );        // OnVerificationStateChangedCallbacks

                    }else{

                        Toast.makeText(RegistrationActivity.this, "Please write vaild phone Number",Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                Log.w("asodjkokwodk", "onVerificationFailed", e);
                loadingBar.dismiss();
